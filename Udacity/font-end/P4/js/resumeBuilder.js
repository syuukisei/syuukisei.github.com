...
var education = {
	...
	display: function() {
		...
		$("#education").append(HTMLonlineClasses.replace("%data%",education.onlineCourses[j].name),
		HTMLonlineTitle.replace("%data%",education.onlineCourses[j].title),
		// HTMLonlineTitle.replace("%url%",education.onlineCourses[j].classUrl),
		HTMLonlineSchool.replace("%data%",education.onlineCourses[j].dates),
		HTMLonlineDates.replace("%data%",education.onlineCourses[j].dates),
		HTMLonlineURL.replace("%data%",education.onlineCourses[j].url)
		// HTMLonlineURL.replace("%url%",education.onlineCourses[j].url)
		);
		// console.log(education.schools[i].name);
		// console.log(i);
		}
